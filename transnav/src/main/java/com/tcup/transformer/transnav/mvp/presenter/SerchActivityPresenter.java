 ...
 */
@ActivityScope
public class SerchActivityPresenter extends BasePresenter<SerchActivityContract.Model, SerchActivityContract.View> {
    @Inject
    ...
    @Inject
    public SerchActivityPresenter(SerchActivityContract.Model model, SerchActivityContract.View rootView) {
