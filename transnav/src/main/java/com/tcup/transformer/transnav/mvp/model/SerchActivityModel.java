 ...
 */
@ActivityScope
public class SerchActivityModel extends BaseModel implements SerchActivityContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SerchActivityModel(IRepositoryManager repositoryManager) {
