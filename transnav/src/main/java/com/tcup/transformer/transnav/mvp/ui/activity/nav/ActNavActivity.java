package com.tcup.transformer.transnav.mvp.ui.activity.nav;
...
public class ActNavActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAMapNavi.addAMapNaviListener(new AMapNaviListener() {
            ...
            public void onArriveDestination() {
                ToastUtil.show(ActNavActivity.this, "您已到达目的地，导航即将结束！");
