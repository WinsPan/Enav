...
import com.tcup.transformer.transnav.di.component.DaggerSiteDetailComponent;
...
import com.tcup.transformer.transnav.mvp.presenter.SiteDetailPresenter;
 ...
 * ================================================
 */
public class SiteDetailActivity extends BaseActivity<SiteDetailPresenter> implements SiteDetailContract.View, View.OnClickListener, AMap.OnMarkerClickListener,
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerSiteDetailComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_site_detail; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
...
//        aMap.setOnMarkerDragListener(markerDragListener);
    ...
    @Override
    public void initMark(SiteListBean siteListBean) {
...
//                    .snippet(marketBean.getSiteRemark())//设置内容
            ...
            ToastUtil.show(SiteDetailActivity.this, "该站点位置信息录入有误，请联系管理员");
        }
    }
        ...
        public void onMarkerDragEnd(Marker arg0) {
            ...
            aMap.addMarker(new MarkerOptions()
                    ...
                    .icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory
                            .decodeResource(getResources(), R.drawable.flag))));
            //设置自定义弹窗
            aMap.setInfoWindowAdapter(new WindowAdapter(SiteDetailActivity.this));
            //绑定信息窗点击事件
            aMap.setOnInfoWindowClickListener(SiteDetailActivity.this);
            aMap.setOnMarkerClickListener(SiteDetailActivity.this);
