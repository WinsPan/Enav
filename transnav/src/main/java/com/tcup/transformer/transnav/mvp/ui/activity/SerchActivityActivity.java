...
import com.tcup.transformer.transnav.di.component.DaggerSerchActivityComponent;
...
import com.tcup.transformer.transnav.mvp.presenter.SerchActivityPresenter;
 ...
 * ================================================
 */
public class SerchActivityActivity extends BaseActivity<SerchActivityPresenter> implements SerchActivityContract.View, View.OnClickListener, AMap.OnMarkerClickListener,
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerSerchActivityComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_serch; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
...
//        aMap.getUiSettings().setMyLocationButtonEnabled(true);//设置默认定位按钮是否显示，非必需设置。
    ...
    AMap.OnMarkerDragListener markerDragListener = new AMap.OnMarkerDragListener() {
        ...
        public void onMarkerDragEnd(Marker arg0) {
            ...
            rangeSiteLists.clear();
            aMap.addMarker(new MarkerOptions()
                    .position(new LatLng(arg0.getPosition().latitude,//设置纬度
                            arg0.getPosition().longitude))//设置经度
                    .title("")//设置标题
                    .snippet("标记")//设置内容
                    .setFlat(true) // 将Marker设置为贴地显示，可以双指下拉地图查看效果
                    .draggable(true) //设置Marker可拖动
                    .icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory
                            .decodeResource(getResources(), R.drawable.flag))));
            //设置自定义弹窗
            aMap.setInfoWindowAdapter(new WindowAdapter(SerchActivityActivity.this));
            //绑定信息窗点击事件
            aMap.setOnInfoWindowClickListener(SerchActivityActivity.this);
            aMap.setOnMarkerClickListener(SerchActivityActivity.this);
            mPresenter.getRangeSites(String.valueOf(arg0.getPosition().longitude), String.valueOf(arg0.getPosition().latitude));
...
//        initMark();
    ...
    public void onMyLocationChange(Location location) {
        ...
        aMap.addMarker(new MarkerOptions()
                .position(new LatLng(location.getLatitude(),//设置纬度
                        location.getLongitude()))//设置经度
                .title("")//设置标题
                .snippet("标记")//设置内容
                .setFlat(true) // 将Marker设置为贴地显示，可以双指下拉地图查看效果
                .draggable(true) //设置Marker可拖动
